...
val halfRed: List<String> = allRed.subList(0, 27)
val allGreen: List<String> = listOf(
    "0xFF00FF00",
    "0xFF00FF00",
    "0xFF00FF00",
    "0xFF00FF00",
...
val halfGreen: List<String> = allGreen.subList(0, 27)
val allBlue: List<String> = listOf(
    "0xFF0000FF",
    "0xFF0000FF",
    "0xFF0000FF",
    "0xFF0000FF",
...
val halfBlue: List<String> = allBlue.subList(0, 27)
val allOff: List<String> = listOf(
    "0x00000000",
    "0x00000000",
    "0x00000000",
    "0x00000000",
...
val halfOff: List<String> = allOff.subList(0, 27)
...
private const val localIp: String = "localhost:3535"
private const val token: String =
    "MEYCIQCZwKr2rmUsyGJNcLexa1sqTsyJtIL9rOzpV4DMaOdpHgIhAM1fvMKZCQy61Pluw4DKDKSX7ChQhgg3BbkD-g7XDAAZ"
